...
export default class tuto_01 extends Phaser.Scene {
    ...
    create() {
        ...
        const mur = map.createLayer( 
            "mur_tuto", // Nom du calque tiled
            tileset
        ); 

        const fin_tuto = map.createLayer( 
            "fin_tuto", // Nom du calque tiled
            tileset
        ); 
    
        
        //CREATION JOUEUR ET PROPRIETES
        this.player = new Player(this, 47,289, 'perso');
        ...
        //fin de niveau
        fin_tuto.setCollisionByExclusion(-1, true);
        this.physics.add.collider(this.player, fin_tuto, () => {
        ...
        map.getObjectLayer('ennemis_tuto').objects.forEach((objet) => {
