...
export default class lv_03 extends Phaser.Scene {
    ...
    create() {
        ...
        this.physics.add.overlap(mur, this.groupe_ball_energie, this.player.annihilation);

        this.physics.add.overlap(this.groupe_ennemis, this.slash, this.player.slash_mobs);
